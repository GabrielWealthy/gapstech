...
export default function About() {
  return (
    <SectionBand id="about" tone="panel">
      <div className="mx-auto max-w-6xl px-6">
        <RevealHeading title="About" from="left" />
        ...
        <div className="mt-8 grid gap-10 md:grid-cols-5 md:gap-12">
          ...
          <motion.div
            ...
            className="flex flex-col gap-4 rounded-2xl border border-ink-border bg-ink p-6 md:col-span-2"
          >
