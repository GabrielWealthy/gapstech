...
export default function FloatingWhatsApp() {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-red shadow-red-lg"
    >
      <span className="absolute inset-0 -z-10 animate-ping rounded-full bg-red opacity-30" />
